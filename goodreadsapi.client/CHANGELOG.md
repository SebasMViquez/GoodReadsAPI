...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest goodreadsapi.client -- --template=react  --no-rolldown --no-immediate`.
...
- Crear archivo de proyecto (`goodreadsapi.client.esproj`).
